...
static int case_test_once_only_bits(void) {
  int before = failures;
  test_once_only_bits();
  return failures != before;
}

static int case_test_tune_table(void) {
  int before = failures;
  test_tune_table();
  return failures != before;
}

static int case_test_screen(void) {
  int before = failures;
  test_screen();
  return failures != before;
}
...
static const TestCase k_cases[] = {
    {"test_once_only_bits", case_test_once_only_bits},
    {"test_tune_table", case_test_tune_table},
    {"test_screen", case_test_screen},
