...
| **`COLDIG.BIN`** | Later | Digital SFX blob — real PCM data, loader RE'd in both `GSOUND.COL`/`PSOUND.COL`, but no reachable playback trigger found anywhere in `VICEROY.EXE`; likely unused. See [assets.md](assets.md). |
