...
SoundFont for FluidSynth is **not** in `COLONIZE/` (`data/soundfonts/`). Numeric BGM/event IDs (`0x20..`; `0x33` is used by woodcut/LCR paths) and PIT tick rate are **EXE-side** — bake those constants.
