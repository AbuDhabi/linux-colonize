...
**Port:** FF election Missing ([`manual_gap.md`](manual_gap.md)); `@FATHERS` century weights live in `NAMES.TXT` / pedia — verify effects in decomp before coding.
...
|--------------|--------|-----------------|
| Stockade: defender strength **+100%**; replaces Fortify benefit inside | [Stockade (Col)](https://civilization.fandom.com/wiki/Stockade_(Col)) | Matches [`building_production.md`](building_production.md) chart; combat Missing |
| Fort: **+150%**; coastal fort slows / fires on adjacent enemy ships (wiki: attack strength 4 + 4 per artillery) | [Fort (Col)](https://civilization.fandom.com/wiki/Fort_(Col)) | Chart +150%; naval fire Missing |
| Fortress: **+200%**; stronger coastal fire (wiki: 8 + 8 per artillery) | [Fortress (Col)](https://civilization.fandom.com/wiki/Fortress_(Col)) | Chart +200%; combat Missing |
| With Stockade/Fort/Fortress, cannot **voluntarily** reduce population below **3** | Stockade / [Colony (Col)](https://civilization.fandom.com/wiki/Colony_(Col)) | **Conflict:** port currently keeps ≥**2** — see Conflicts |
...
|-------|------|----------------------|--------|
| Stockade+ min voluntary population | Below **3** | Port eject keeps ≥**2** ([`manual_gap.md`](manual_gap.md), [`assets.md`](assets.md)) | Confirm vs DOS / manual; fix port if code says 3 |
