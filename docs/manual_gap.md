...
| Assign jobs / field work / production numbers | Missing | |
| Construction queue + buy with gold | Missing | Hammers stub only |
...
1. **Colony economy UI** — jobs, fields, production, build queue (“Working the Colony”)
