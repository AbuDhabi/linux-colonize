...
| `4d56_00e0`/`01e2`/`14fe` | `00e0` = tribe-settlement DESTROY (despawn village-bound units, compact array, village-count decrement, extinction bit + @EXTINCT, horse fold — ported into `col1_destroy_tribe_at` 2026-09-07d); `01e2`/`14fe` = per-tribe act plumbing | growth + pulse (act loop golden-pinned) | `00e0` **Done**; `01e2`/`14fe` partial (T2 quiet) |
