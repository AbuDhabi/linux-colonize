...
static const DumpSongTitle k_default_titles[] = {
  ...
  {0x2d, "Love Forever"},
  {0x2e, "York Fusiliers"},
  {0x2f, "Washington Artillery March"},
  {0x30, "Road to Boston"},
  {0x31, "Independence Way"},
  {0x32, "The Reveille"},
  {0x33, "Introduction"},
  {0x34, "Successful Campaign"},
  {0x35, "Morelli's Lesson"},
  {0x36, "To Arms"},
  {0x37, "Indian Victory"},
  {0x38, "Natives"},
  {0x39, "Tenochtitlan"},
  {0x3a, "Pizarro at Cuzco"},
  {0x3b, "English"},
  {0x3c, "French"},
  {0x3d, "Spanish"},
  {0x3e, "Dutch"},
  {0x3f, "Fountain of Youth"},
};
