...
#define COLONY_VIEWPORT_W (COLONY_MINIMAP_SECTION_X - 1)
...
#define COLONY_PANEL_CONTENT_Y (COLONY_BOTTOM_PANEL_Y + 2)
#define COLONY_PANEL_CONTENT_H (COLONY_CARGO_STRIP_Y - COLONY_PANEL_CONTENT_Y - 2)
